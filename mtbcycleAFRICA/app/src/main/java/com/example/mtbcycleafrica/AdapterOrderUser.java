...
public class AdapterOrderUser extends RecyclerView.Adapter<AdapterOrderUser.HolderOrderUser> {
    ...
    public void onBindViewHolder(@NonNull HolderOrderUser holder, int position) {
        ...
        holder.amountTv.setText("Amount:KES" + orderCost);
        ...
        if (orderStatus.equals("In progress")) {
            ...
            holder.statusTv.setTextColor(context.getResources().getColor(R.color.greenn));
        ...
        ref.child(modelOrderUser.getOrderTo())
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        Toast.makeText(context, "shop info", Toast.LENGTH_SHORT).show();
    ...
    class HolderOrderUser extends RecyclerView.ViewHolder {
        TextView orderIdTv, amountTv, statusTv, dateTv;
        ImageView nextIv;
